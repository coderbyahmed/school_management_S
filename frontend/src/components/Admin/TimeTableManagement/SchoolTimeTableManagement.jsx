...
import AllClassesTimetable from './AllClassesTimetable/AllClassesTimetable';
import CreateTimetable from './CreateTimetable/CreateTimetable';
import ViewTimetable from './ViewTimetable/ViewTimetable';
import TimetableDesigner from './TimetableDesigner/TimetableDesigner';
...
const SchoolTimeTableManagement = () => {
  return (
    <TimetableProvider>
      <TimetableContent />
    </TimetableProvider>
...
export default SchoolTimeTableManagement;
