        ...
        {moreItems.map((item, index) => (
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              } ${index < moreItems.length - 1 ? 'border-b border-gray-100 dark:border-gray-700' : ''}`
            }
          >
            <span className="text-gray-500 dark:text-gray-400">{item.icon}</span>
            {item.label}
            <svg className="w-4 h-4 ml-auto text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
...
export default TeacherMoreMenu;
