  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 hover:shadow-md transition-shadow flex flex-col items-center text-center">
          ...
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Class Name</h3>
          <div className="mt-2">
            <StatusBadge status="Active" />
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">2026-2027</p>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 hover:shadow-md transition-shadow flex flex-col">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-auto">0</p>
        </div>
